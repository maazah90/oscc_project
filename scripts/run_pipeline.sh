...
SCRIPT1=$SCRIPT_DIR/step1_generate_PoN_inputs.sh   # BQSR
SCRIPT2=$SCRIPT_DIR/step2_mutect2_variant_calling.sh   # Tumor-only Mutect2
...
echo "Check results/recal/ for *_recal.bam files."
...
echo "Check results/mutect2/ for *_filtered.vcf.gz files."
